...
public class Cellist extends Person implements Musician {                                           //Creating a class which extends the Person class and implements the Musician Interface
    ...
    public Cellist(String name, SoundSystem soundSystem) {                                          //Creating a constructor
        super(name);
    ...
    public Cellist(String name, SoundSystem soundSystem, int seat) {                                //Creating a constructor
        super(name);
        this.soundSystem = soundSystem;
        this.instrumentID = 43;
        this.notes = new ArrayList<>();
