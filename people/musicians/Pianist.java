...
public class Pianist extends Person implements Musician {                                           //Creating a class which extends the Person class and implements the Musician Interface
    ...
    public Pianist(String name, SoundSystem soundSystem) {                                          //Creating a constructor
        super(name);
    ...
    public Pianist(String name, SoundSystem soundSystem, int seat) {                                //Creating a constructor
        super(name);
        this.soundSystem = soundSystem;
        this.instrumentID = 1;
        this.notes = new ArrayList<>();
